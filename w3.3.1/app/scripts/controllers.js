...
app.controller("DishDetailController", ["$scope", "$routeParams", "dishesService", function($scope, $routeParams, dishesService) {
    $scope.dish = dishesService.getDish(parseInt($routeParams.id, 10));
